    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="mb-12">
        <div class="flex items-center justify-between mb-6">
          <div>
            <h1 class="text-4xl font-bold mb-2">X402 Vue.js Demo</h1>
      ...
      <div class="space-y-6">
        ...
        <div v-if="!connected" class="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
...
import X402EndpointCard from '@/components/X402EndpointCard.vue'
